use waridley_aoc_2022::day_6::{find_marker, eval_part_2};
...
fn part_1() {
    ...
    assert_eq!(find_marker("nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg".as_bytes(), 14), 29);
    assert_eq!(find_marker("zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw".as_bytes(), 14), 26);
